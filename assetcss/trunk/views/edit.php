...
////////////////////////////////////////////////////////////////////////////////
?>
<h1><?php echo __(ucfirst($action).' css asset'); ?></h1>
<form action="<?php echo $action=='edit' ? get_url('plugin/assetcss/edit/'.$asset->id): get_url('plugin/assetcss/add'); ; ?>" method="post">
	<div class="form-area">
		...
		<div id="pages" class="pages">
			<div id="assetcss" class="page" style="">
				<textarea
					class="textarea"
					cols="40"
					id="asset_content"
	...
	<p class="buttons">
		...
		<?php echo __('or'); ?> <a href="<?php echo get_url('plugin/assetcss'); ?>"><?php echo __('Cancel'); ?></a>
	</p>
</form>

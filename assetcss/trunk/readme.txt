...
>>> INTRODUCTION
================================================================================
AssetCss is a plugin which allows you to manage your Css files just like
you would a Page / Snippet / Layout with-in WolfCms. The main advantage is
that we can compress the css automatically, instead of a manual
...
Also there is a companion plugin that does the same thing for Js.

>>> INSTALL
================================================================================
To install, simply unzip into your plugins folder making sure the folder name
is "assetcss" and then login to wolf and enable it - too easy...

If you want to be able to refrence the css assets with a .css extension.
